...
class GedcomWriterOptionBox(WriterOptionBox):
    ...
    def get_option_box(self):
        ...
        vbox1.pack_start(self.include_witnesses_check, False, False, 0)
        vbox1.pack_start(self.include_media_check, False, False, 0)
        vbox1.pack_start(self.include_depot_check, False, False, 0)
        vbox1.pack_start(self.relativepath_check, False, False, 0)
        vbox1.pack_start(self.extended_role_check, False, False, 0)
        vbox1.pack_start(self.quaynote_check, False, False, 0)
        vbox1.pack_start(self.zip_check, False, False, 0)
        vbox1.pack_start(self.namegen_check, False, False, 0)
        vbox1.pack_start(self.nameus_check, False, False, 0)
        vbox1.pack_start(self.anychar_check, False, False, 0)
        vbox1.pack_start(self.citattr_check, False, False, 0)
        vbox2.pack_start(self.inccensus_check, False, False, 0)
        vbox2.pack_start(self.inccensusplus_check, False, False, 0)
        vbox2.pack_start(self.urlshort_check, False, False, 0)
        vbox2.pack_start(self.parentsrc_check, False, False, 0)
        vbox2.pack_start(self.extprog_check, False, False, 0)
        vbox2.pack_start(self.altname_check, False, False, 0)
        vbox2.pack_start(self.placegeneanet_check, False, False, 0)
